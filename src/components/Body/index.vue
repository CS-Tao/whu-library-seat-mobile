              ...
              <el-select v-model="form.seatNum" placeholder="座位号" class="num">
                <el-option v-for="n in seatsForSelect.length" :key="n-1" :label="seatsForSelect[n-1].name" :value="seatsForSelect[n-1].id">
                  ...
                  <span class="seat-option-right">
                    <svg class="seat-flag" :class="{'seat-flag-computer':seatsForSelect[n-1].computer}" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M911.7 127.7H112.3C80.2 127.7 54 153.8 54 186v519.8c0 32.1 26.2 58.3 58.3 58.3h295.4v62.3c0 7.6-2.6 15-7.3 21l-15.8 12.9c-6.7 5.5-9.2 14.4-6.3 22.6 2.9 8.2 10.4 13.5 19.2 13.5h229.1c8.7 0 16.2-5.3 19.2-13.5 2.9-8.2 0.5-17.1-6.3-22.6l-15.8-12.9c-4.7-6-7.3-13.4-7.3-21v-62.3h295.4c32.1 0 58.3-26.2 58.3-58.3V186c-0.1-32.2-26.3-58.3-58.4-58.3zM608.9 860.8c0.4 0.5 0.9 0.9 1.3 1.3l16.6 13.5 0.1 0.1c0 0.1-0.1 0.4-0.1 0.5H397.3c-0.1-0.1-0.2-0.4-0.2-0.4l0.2-0.2 16.6-13.5c0.5-0.4 0.9-0.8 1.3-1.3 8.1-9.7 12.5-21.9 12.5-34.5V764h168.6v62.3c0 12.6 4.5 24.9 12.6 34.5z m341.1-155c0 21.1-17.2 38.3-38.3 38.3H112.3c-21.1 0-38.3-17.2-38.3-38.3V186c0-21.1 17.2-38.3 38.3-38.3h799.4c21.1 0 38.3 17.2 38.3 38.3v519.8z"></path><path d="M865.3 202.3H158.7c-18.6 0-33.8 15.1-33.8 33.8v387.2c0 18.6 15.1 33.8 33.8 33.8h706.6c18.6 0 33.8-15.1 33.8-33.8V236c0-18.6-15.2-33.7-33.8-33.7z m13.8 420.9c0 7.6-6.2 13.8-13.8 13.8H158.7c-7.6 0-13.8-6.2-13.8-13.8V236c0-7.6 6.2-13.8 13.8-13.8h706.6c7.6 0 13.8 6.2 13.8 13.8v387.2z"></path></svg>
