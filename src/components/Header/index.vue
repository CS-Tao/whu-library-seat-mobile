<template>
	<div class="header" :class="{'header-unlogin': !hasToken}" style="overflow-y:scroll">
    ...
    <el-form
      ...
      <div style="margin:0 20px;">
        <div class="form-item" style="margin: 0 0 40px 0" v-if="!hasToken">
          <svg version="1.1" class="logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.004 512.004" style="enable-background:new 0 0 512.004 512.004;" xml:space="preserve"><g>
        ...
        <el-form-item inline prop="account" class="form-item" style="margin-bottom: 15px;">
          <el-row :gutter="0" align="middle">
            ...
            <el-col :span="17" :offset="1">
              <el-input :disabled="accountLocked" v-model.number="userInfo.account" clearable prefix-icon="el-icon-edit" class="input"></el-input>
            </el-col>
        ...
        <el-form-item prop="passwd" class="form-item">
          <el-row :gutter="0" align="middle">
            <el-col :span="3">
              <span >密码</span>
            </el-col>
            <el-col :span="17" :offset="1">
              <el-input :disabled="passwdLocked" type="password" v-model="userInfo.passwd" auto-complete="off" clearable prefix-icon="el-icon-edit" class="input"></el-input>
            </el-col>
            <el-col :span="2" :offset="1">
      ...
      return new Promise((resolve, reject) => {
        ...
        gitcontentsApi.validateUser().then((response) => {
          if (response.data.status === 'success') {
            ...
            // 用户验证
            const validateFailMessage = '对不起，您未在用户白名单中，不能使用本软件。<a style="color:rgb(77, 136, 255);" href="javascript:void(0)" onclick="window.open(\'https://home.cs-tao.cc/whu-library-seat/specification/#申请软件使用权\')">申请权限</a>'
            if (userItem === null) {
