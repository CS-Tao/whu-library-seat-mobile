<template>
    ...
    <div class="warper flex-col" @click="openMainBody()">
      ...
      <i v-if="!hasToken" class="operation-icon" style="margin-right: 16px;" @click="openSource()">
      ...
      <!-- <span style="cursor: default!important;" v-if="!hasToken">&nbsp;&nbsp;</span>
      <i v-if="!hasToken" class="exit-button" @click.stop="exitApp()" style="margin-right: 8px;">
